    ...
    <div className="about-container">
      ...
      <div className="about-extra-info">
        ...
        <section className="about-section">
          ...
          <p className="about-section-content">
            Founded in 2010, our company has grown from a small startup to a leading player in the industry. Here are some key milestones:
          </p>
        </section>
      </div>
    </div>
